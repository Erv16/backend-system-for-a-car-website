...
class CarController {
     ...
     */
    @ApiResponses(value = {
            @ApiResponse(code=200, message = "Retrieved list of cars of successfully"),
    ...
    @GetMapping("/{id}")
    @ApiResponses(value = {
            @ApiResponse(code=200, message = "The requested Car has been retrieved successfully. "),
            @ApiResponse(code=400, message = "This is a bad request, please follow the API documentation for the proper request format."),
            @ApiResponse(code=401, message = "Due to security constraints, your access request cannot be authorized. "),
            @ApiResponse(code=500, message = "The server is down. Please make sure that the Vehicle-API microservice is running.")
    })
     ...
     */
    @ApiResponses(value = {
            @ApiResponse(code=200, message = "The Car has been created successfully. "),
            @ApiResponse(code=400, message = "This is a bad request, please follow the API documentation for the proper request format."),
            @ApiResponse(code=401, message = "Due to security constraints, your access request cannot be authorized. "),
            @ApiResponse(code=500, message = "The server is down. Please make sure that the Vehicle-API microservice is running.")
    })
     ...
     */
    @ApiResponses(value = {
            @ApiResponse(code=200, message = "The Car has been updated successfully. "),
            @ApiResponse(code=400, message = "This is a bad request, please follow the API documentation for the proper request format."),
            @ApiResponse(code=401, message = "Due to security constraints, your access request cannot be authorized. "),
            @ApiResponse(code=500, message = "The server is down. Please make sure that the Vehicle-API microservice is running.")
    })
     ...
     */
    @ApiResponses(value = {
            @ApiResponse(code=200, message = "The Car has been deleted successfully. "),
            @ApiResponse(code=400, message = "This is a bad request, please follow the API documentation for the proper request format."),
            @ApiResponse(code=401, message = "Due to security constraints, your access request cannot be authorized. "),
            @ApiResponse(code=500, message = "The server is down. Please make sure that the Vehicle-API microservice is running.")
    })
